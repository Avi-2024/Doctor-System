...
router.post('/signup', auditLogger({ action: 'AUTH_SIGNUP', resourceType: 'user', logOnlySuccess: true }), authController.signup);
router.post('/login', auditLogger({ action: 'AUTH_LOGIN', resourceType: 'user', logOnlySuccess: true }), authController.login);
